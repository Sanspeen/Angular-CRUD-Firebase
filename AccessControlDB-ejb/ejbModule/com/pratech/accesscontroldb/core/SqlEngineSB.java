...
public class SqlEngineSB implements SqlEngineSBLocal {
	...
	public String[] connectionEntry(DataConnection dataConnection) {
		...
		String url;
		if (dataConnection.getInstance().equals("SQLServes")) {
			url = "jdbc:sqlserver://10.201.121.52:1433;databaseName=DB_DINAMICA_MEDELLIN;user=71784510;password=71784510";
		} else {
			url = urlConnection.URLSearch(dataInstance);
		}
